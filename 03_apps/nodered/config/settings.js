/*
  Mostly default settings from the template settings file at 
    https://github.com/node-red/node-red/blob/834a4d8cb8dba71d8787079197517cf5a54c74ed/packages/node_modules/node-red/settings.js
*/
 ...
 ******************************************************************************/
     ...
     * lost.
     */
    credentialSecret: getSecretValue("MY_NODERED_CREDENTIAL_SECRET"),
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        type: "credentials",
        users: [{
            username: getSecretValue("MY_NODERED_ADMIN_USERNAME"),
            // Hacky way for not having to store the hashed password in bitwarden...
            // -> https://nodered.org/docs/user-guide/runtime/securing-node-red
            password: require('bcryptjs').hashSync(getSecretValue("MY_NODERED_ADMIN_PASSWORD"), 8),
            permissions: "*"
        }]
    },
